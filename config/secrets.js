...
module.exports = {
  ...
  db: process.env.MONGODB || 'mongodb://markgu:gutec1@ds047772.mongolab.com:47772/heroku_892d367w',

  sessionSecret: process.env.SESSION_SECRET || 'Your Session Secret goes here',

  mailgun: {
    user: process.env.MAILGUN_USER || 'postmaster@sandboxe524006a876f40e09a4a6fadb0ebee22.mailgun.org',
    password: process.env.MAILGUN_PASSWORD || '485e648f09e72d0352b6e804cfb85c3d'
  },
